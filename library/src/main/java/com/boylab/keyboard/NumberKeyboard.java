...
public class NumberKeyboard extends AbstractKeyboard{
    ...
    public NumberKeyboard(Context context, int maxLen, OnKeyActionListener commitListener) {
    ...
    public static NumberKeyboard create(Context context, int maxLen, OnKeyActionListener listener) {
